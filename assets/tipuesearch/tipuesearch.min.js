...
{var m_c=tipuesearch_in.pages[i].title.match(pat).length;score+=(40*m_c);}
if(tipuesearch_in.pages[i].text.search(pat)!=-1)
{var m_c=tipuesearch_in.pages[i].text.match(pat).length;score+=(5*m_c);}
if(tipuesearch_in.pages[i].tags.search(pat)!=-1)
{var m_c=tipuesearch_in.pages[i].tags.match(pat).length;score+=(70*m_c);}
...
{
  //out+='<br><br>';
  out+='<div class="tipue_search_not_found">'+tipuesearch_string_8+'</div>';
